...
class RTraPro:
    ...
    def __init__(self, master):
        ...
        lbl_2 = tkinter.Label(win, text="REPORTE DE TRANSACCIONES POR PROVEEDOR", bg=color[0], font='arial 16')
        ...
        lbl_5 = tkinter.Label(win, text="CODIGO", bg=color[2], font='arial 10')
        lbl_5.grid(column=0, row=3, pady=5)

        self.txt_in3 = tkinter.Entry(win, width=4, font='arial 12')
        ...
        self.mensaje = tkinter.Listbox(win, height=20, width=80, font='arial 11')
